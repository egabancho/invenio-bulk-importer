...
project = "Invenio-Bulk-Importer"
copyright = "2025, Ubiquity Press"
...
html_theme_options = {
    ...
    "github_repo": "invenio-bulk-importer",
    "github_button": False,
    "github_banner": True,
    "show_powered_by": False,
    "extra_nav_links": {
        "invenio-bulk-importer@GitHub": (
            "https://github.com/ubiquitypress/invenio-bulk-importer"
        ),
        "invenio-bulk-importer@PyPI": (
            "https://pypi.python.org/pypi/invenio-bulk-importer/"
        ),
    },
}
...
htmlhelp_basename = "invenio-bulk-importer_namedoc"
...
latex_documents = [
    (
        master_doc,
        "invenio-bulk-importer.tex",
        "invenio-bulk-importer Documentation",
        "Ubiquity Press",
        "manual",
    ),
]
